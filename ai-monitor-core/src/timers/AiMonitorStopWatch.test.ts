...
import AiMonitorStopWatch, { TimerKeys, LogHistory } from "./AiMonitorStopWatch";
...
describe("AiStopWatch", () => {
    ...
    it("should call start method of appropriate internal stopwatch", () => {
        ...
        const workStopWatchStart = (aiStopWatch as any)._timers[TimerKeys.WORK_TIMER].start = jest.fn();
        const lunchStopWatchStart = (aiStopWatch as any)._timers[TimerKeys.LUNCH_TIMER].start = jest.fn();
        const coffeeStopWatchStart = (aiStopWatch as any)._timers[TimerKeys.COFFEE_TIMER].start = jest.fn();
    ...
    it("should call stop method of appropriate internal stopwatch", () => {
        ...
        const workStopWatchStop = (aiStopWatch as any)._timers[TimerKeys.WORK_TIMER].stop = jest.fn();
        const lunchStopWatchStop = (aiStopWatch as any)._timers[TimerKeys.LUNCH_TIMER].stop = jest.fn();
        const coffeeStopWatchStop = (aiStopWatch as any)._timers[TimerKeys.COFFEE_TIMER].stop = jest.fn();
